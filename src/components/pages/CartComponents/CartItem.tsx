...
import { addToCart, decrementItemCount, removeFromCart } from '../../../redux/slices/cartSlice';
...
export const CartItem: React.FC<CartItemProps> = ({ id, title, price, img, type, size, count }) => {
