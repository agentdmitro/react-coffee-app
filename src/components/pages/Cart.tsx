...
export const Cart: React.FC = () => {
  ...
  const addedItems = items.reduce((sum: number, item: any) => sum + item.count, 0);

  const onClearItems = () => {
    if (window.confirm('Ви дійсно хочете прибрати все з кошику?')) {
      dispatch(clearCart());
    }
  };
